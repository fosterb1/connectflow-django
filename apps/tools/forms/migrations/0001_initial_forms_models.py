# Generated by Django 5.2.9 on 2026-01-13 14:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('show_if_field', models.ForeignKey(blank=True, help_text='Show this field only if another field has specific value', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='dependent_fields', to='forms.formfield')),
            ],
            options={
