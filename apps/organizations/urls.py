...
urlpatterns = [
    ...
    path('projects/<uuid:project_pk>/meetings/<uuid:meeting_pk>/edit/', views.project_meeting_edit, name='project_meeting_edit'),
    path('projects/<uuid:project_pk>/meetings/<uuid:meeting_pk>/delete/', views.project_meeting_delete, name='project_meeting_delete'),
    ...
    path('projects/<uuid:pk>/risks/', views.project_risk_dashboard, name='project_risk_dashboard'),
    path('projects/<uuid:pk>/risks/add/', views.add_project_risk, name='add_project_risk'),
    path('projects/<uuid:pk>/audits/add/', views.add_audit_trail, name='add_audit_trail'),
    path('projects/<uuid:pk>/controls/add/', views.add_control_test, name='add_control_test'),
    path('projects/<uuid:pk>/compliance/add/', views.add_compliance_requirement, name='add_compliance_requirement'),
    path('projects/<uuid:pk>/compliance/<uuid:req_pk>/delete/', views.delete_compliance_requirement, name='delete_compliance_requirement'),
    path('projects/<uuid:pk>/compliance/<uuid:req_pk>/evidence/add/', views.add_compliance_evidence, name='add_compliance_evidence'),
    path('projects/<uuid:pk>/evidence/<uuid:evidence_pk>/delete/', views.delete_compliance_evidence, name='delete_compliance_evidence'),
